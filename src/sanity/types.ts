...
export type BLOG_QUERY_BY_IDResult = {
  _id: string;
  title: string | null;
  slug: Slug | null;
  _createdAt: string;
...
// Variable: AUTHOR_BY_GOOGLE_ID
// Query: *[_type == 'author' && id == $id][0]{            _id,             id,            name,            username,            email,            image,            bio        }
export type AUTHOR_BY_GOOGLE_IDResult = {
  _id: string;
  id: number | null;
  name: string | null;
  username: string | null;
